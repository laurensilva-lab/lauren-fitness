...
const IconNut = (a) => (
  <svg width="21" height="21" viewBox="0 0 24 24" fill="none"
    stroke={a?"#fff":"#3a3a3a"} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"
    style={{transition:"all 280ms ease",filter:a?"drop-shadow(0 0 5px rgba(255,255,255,0.6))":"none"}}>
