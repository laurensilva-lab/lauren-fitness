const icons = {
  ...
  nutricion: (a) => <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke={a?"#fff":"#3a3a3a"} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{transition:"all 280ms ease",filter:a?"drop-shadow(0 0 4px rgba(255,255,255,0.5))":"none"}}><path d="M12 2a3 3 0 0 0-3 3c0 1.5 1 2.5 1 2.5H8C5.8 7.5 4 9.3 4 11.5c0 4.7 3.8 8.5 8 8.5s8-3.8 8-8.5C20 9.3 18.2 7.5 16 7.5h-2s1-1 1-2.5a3 3 0 0 0-3-3z"/></svg>,
