...
const s = {
  sidebar: {
    width: "200px", flexShrink: 0, height: "100vh", position: "sticky", top: 0,
  ...
  dot: {
    ...
    background: "#fff", boxShadow: "0 0 10px rgba(255,255,255,0.6)", flexShrink: 0,
  ...
  divider: {
    height: "1px",
    background: "linear-gradient(90deg, transparent, #222 30%, #2a2a2a 50%, #222 70%, transparent)",
    margin: "18px 0",
  },
  ...
  activeBar: {
    ...
    width: "2px", background: "#fff", borderRadius: "0 2px 2px 0",
